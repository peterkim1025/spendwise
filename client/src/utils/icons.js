export const dashboard = <i class="fa-solid fa-house-user"></i>
...
export const incomes = <i class="fa-solid fa-money-check-dollar"></i>
...
export const utensils = <i className="fa-solid fa-utensils"></i>
